...
export default function SignUp() {
  ...
  const onSignIn = (values: { name: string, email: string, newPassword: string, confirmPassword: string }) => {
    console.log(values)
  }
    ...
    <div className="flex min-h-screen flex-1 flex-col justify-center px-6 py-12 lg:px-8">
      ...
      <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
        ...
        <p className="mt-10 text-center text-sm text-gray-500">
          já tem uma conta?{' '}
          <Link href="/signin" className="font-semibold leading-6 text-gray-700 hover:text-gray-600">
            acesse aqui
          </Link>
        </p>
      </div>
